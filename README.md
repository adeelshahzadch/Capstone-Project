...
|---|-----------------|--------------------|---------------------------------------------------------------------------------------------------------|------------------------------------------|
| 1 | Initialization  | Initialize DB Agent    | Prepare the knowledge base (Pinecone) by processing and inserting document embeddings.                 | insert_embeddings_task (Setup)           |
...
| 4 | Reflection      | Reflection Agent   | Refine and structure the generated draft answer to ensure it is concise and clear.                     | refine_answer_task                       |
| 5 | Evaluation      | Evaluation Agent   | Critique the final answer against quality standards (Accuracy, Relevance, Clarity) and output a score. | evaluate_answer_task                     |
